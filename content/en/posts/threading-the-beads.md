...
tags = ["Gemini", "AI"]
description = "In an era where AI can generate code instantly, the true value of a developer lies in creativity and intent."
...
The first bead I’ve picked is the classic masterpiece **[Pong](https://github.com/bebechien/history-of-video-game/blob/main/pong.md)**.
...
If you’re curious how these specs turn into a "treasure," check out **[this link](https://gemini.google.com/share/dde7d4c8deea)** to see Gemini's implementation.

![PONG built by Gemini](images/gemini-pong.gif)

The process with current technology is surprisingly simple. Go to [gemini.google.com](https://gemini.google.com), turn on the **"Canvas"** feature, and hand over the game spec (`pong.md`). Then, just say one thing: **"Build this game."** The code appears like magic.
...
Services like **[Astrocade](https://www.astrocade.com/)** are already showing us glimpses of that experimental future.
