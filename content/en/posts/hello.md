...
tags = ["AI"]
description = "In the era of AI, where machines can do things faster, what is the value of human creativity?"
...
At the time, I felt a strange thirst when looking at models trained primarily on Western art styles. So, I spent time [painstakingly crafting datasets](https://huggingface.co/datasets/bebechien/shinyunbok_xl) and fell deeply into the [fun of teaching AI](https://civitai.com/user/bebechien) the brushstrokes of [Shin Yun-bok](https://en.wikipedia.org/wiki/Sin_Yunbok), a painter from the Joseon Dynasty.
...
At an [AI Workshop](https://luma.com/6iyf5pca) I attended yesterday, someone asked me a heavy question:
