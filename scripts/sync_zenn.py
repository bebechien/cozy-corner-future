import os
from sync_utils import load_hugo_post, transform_image_urls, transform_youtube_links, transform_relref_links, save_post, GITHUB_PAGES_BASE
...
def run_zenn_sync():
    with os.scandir(SOURCE_DIR) as entries:
        for entry in entries:
            ...
            content = transform_youtube_links(content)
