...
How do we eat this ramen? We have to visit the restaurant ([gemini.google.com](https://gemini.google.com)) or order delivery. We can’t see inside the kitchen to know what secret broth they’re using or how they control the heat.
...
The biggest appeal? You can take it home for **free**. Once you [download](https://huggingface.co/google/collections) it to your computer, you can cook it up anytime, even if the internet goes down.

The real fun of this "instant noodle" (Gemma) starts once you bring it home. ([Gemma model fine-tuning](https://ai.google.dev/gemma/docs/tune))
...
* **Creating Something New (Full Model Tuning):** You can even take the noodles and soup base and completely reinvent them into a new dish, like *[Rabokki](https://en.wikipedia.org/wiki/Rabokki)* (Ramen Tteokbokki) or *[Budae-Jjigae](https://en.wikipedia.org/wiki/Budae-jjigae)* (Army Stew).
...
If you visit the [Gemmaverse](https://deepmind.google/models/gemma/gemmaverse/), you can check out various tasty experiments people have made.

# But There Are a Few Caveats!

Of course, to cook instant noodle, you need a few supplies.

1. **Your Own Kitchen:** You need a pot and a stove with good heat-in other words, a computer with a **High-Performance GPU**.
2. **Cooking Utensils:** You need tools like a ladle or chopsticks, which correspond to the right environment and frameworks.
3. **Cooking Skills:** Most importantly, you need the **cooking (development) knowledge** to know how much water to add and how long to boil it. If you can't cook at all, even delicious instant noodle might remain a "pie in the sky".
...
Actually, there's a little backstory to how this comic was born. Have you by any chance seen the cute [Chrome character](https://x.com/googlejapan/status/1862051304228434163) from Google Japan's X (Twitter)?
...
Next, I took this clumsy character sketch and rough story to [Gemini's image generation feature](https://gemini.google/overview/image-generation/), which carries the nickname "Nano Banana." I asked it, *"Please draw a 4-panel comic with these kids based on this story!"*
