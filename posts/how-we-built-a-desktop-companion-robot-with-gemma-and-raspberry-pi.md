...
cover_image: images/how-we-built-a-desktop-companion-robot.png
description: The behind-the-scenes story of how we built DinoDesk AI—a privacy-first,
  LEGO dino companion robot powered by a hybrid Local Gemma 4 and Cloud Gemini architecture.
published: true
tags:
- Hardware
- Raspberry Pi
